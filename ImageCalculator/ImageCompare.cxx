...
int RegressionTestImage (const char *testImageFilename, const char *baselineImageFilename, int reportErrors)
{
    ...
    if (status && reportErrors)
        ...
        diffName << (itksys::SystemTools::GetFilenamePath(baselineImageFilename) + "/" + itksys::SystemTools::GetFilenameName(std::string(testImageFilename))) << ".diff.png";
        try
            {
            rescale->SetInput(diff->GetOutput());
            rescale->Update();
        ...
        baseName << (itksys::SystemTools::GetFilenamePath(baselineImageFilename) + "/" + itksys::SystemTools::GetFilenameName(std::string(testImageFilename))) << ".base.png";
        try
            {
        ...
        testName << (itksys::SystemTools::GetFilenamePath(baselineImageFilename) + "/" + itksys::SystemTools::GetFilenameName(std::string(testImageFilename))) << ".test.png";
        try
            {
