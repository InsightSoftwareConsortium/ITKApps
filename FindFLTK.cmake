...
IF(NOT FLTK_VERSION_PATCH GREATER 6) ##ONLY NEEDED FOR FLTK <= 1.1.6
  IF(FLTK_FOUND)
    ...
    SET(FLTK_LIBRARIES ${FLTK_IMAGES_LIBRARY} ${FLTK_IMAGES_LIBS} ${FLTK_BASE_LIBRARY} ${FLTK_GL_LIBRARY}
      ${FLTK_FORMS_LIBRARY} CACHE INTERNAL "The FLTK_LIBRARIES")
    IF(APPLE) ## Apple needs platforms defined before libraries
      SET(FLTK_LIBRARIES ${FLTK_PLATFORM_DEPENDENT_LIBS} ${FLTK_LIBRARIES} CACHE INTERNAL "The FLTK_LIBRARIES")
    ELSE(APPLE)
      SET(FLTK_LIBRARIES ${FLTK_LIBRARIES} ${FLTK_PLATFORM_DEPENDENT_LIBS} CACHE INTERNAL "The FLTK_LIBRARIES")
    ENDIF(APPLE)
  ENDIF(FLTK_FOUND)
ENDIF(NOT FLTK_VERSION_PATCH GREATER 6) ##ONLY NEEDED FOR FLTK <= 1.1.6
