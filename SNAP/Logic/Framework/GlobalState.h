...
public:
  ...
  /** The lesser valued (index=0) or higher valued (index=1) corner
   * of the region of interest. */
  Vector3i GetROICorner(unsigned int index);
  void SetROICorner(unsigned int index, const Vector3i &corner);
...
private:
  ...
  //ROI upper left, lower right points
  Vector3i m_ROIUpperLeft;
  Vector3i m_ROILowerRight;
