/*=========================================================================
  ...
  Module:    LevelSetImageWrapperImplementation.cxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
LevelSetImageWrapperImplementation::DisplayPixelType
LevelSetImageWrapperImplementation::MappingFunctor
::operator()(float in)
{
  ...
  /*
  LevelSetImageWrapperImplementation::DisplayPixelType pixel(m_OutsidePixel);
...
LevelSetImageWrapperImplementation::DisplaySlicePointer 
LevelSetImageWrapperImplementation
